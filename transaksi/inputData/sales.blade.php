...
<div class='container'>
    <div class="row py-5">
        ...
        <div class="col-md-6 mt-4 border py-4 px-4">
            <h3 class="mb-4">Form-Sales</h3>
            <form action="/dashboard/sales" method="post" class="form">
                @csrf
                     @if($title === "Update")
            @foreach($data as $p)
            ...
            <div class="md-3">
                ...
                <input value="{{ $p->kodesales }}" type="text" name="kodesales" class="form-control">
            </div>
               <div class="md-3">
            ...
            <div class="md-3">
                <label class="mb-2" for="">Kodesales</label>
                <input  type="text" name="kodesales" class="form-control">
            </div>
               <div class="md-3">
                <label class="mb-2" for="">Nama</label>
  ...
  <tbody>
   @foreach($data as $p) 
    <tr class="text-center">
        ...
        <td>{{ $p->alamat }}</td>
        <td>
            <a href="/dashboard/showEditSales/{{ $p->kodesales }}" class="btn btn-success">Update</a>
            <a href="/dashboard/deleteSales/{{ $p->kodesales }}" class="btn btn-danger">Delete</a>
